...
#분류(전역평균 풀링 또는 완전연결층) 부분만으로 구성된 model_2 만들기
...
color_heatmap=keras.prreprocessing.image.array_to_img(color_heatmap)
color_heatmap=color_heatmap.resize((img.shape[1],img.shape[0]))
color_heatmap=keras.prreprocessing.image.img_to_array(color_heatmap)

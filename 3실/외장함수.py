...
# print(datetime.today().year) # 연도 가져오기
# print(datetime.today().month) # 월 가져오기
# print(datetime.today().day) # 일 가져오기
# print(datetime.today().hour) # 시 가져오기
# print(datetime.today().minute) # 분 가져오기
# print(datetime.today().second) # 초 가져오기

# 수학 계산을 위한 math
import math
print(math.sin(100)) # 사인값
print(math.cos(100)) # 코사인값
print(math.tan(100)) # 탄젠트값
...
while True :
    ...
    if rand not in ls : # list 에 생성된 rand 값이 포함되어 있지 않으면 
        ls.append(rand)
    if len(ls) == 6 : break
print(ls)
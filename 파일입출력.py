...
# 파일모드 : r(읽기), w(쓰기, 기존내용 삭제 후 새롭게 작성), a(추가, 파일이 없다면 생성하고 추가됨, 있으면 파일의 마지막에 추가) /
...
# readline() : 해당 파일의 내용을 한 라인씩 읽어들여 문자열로 반환
...
#     print(line, end=" ") # 한 줄씩 읽어서 출력하기 때문에 줄바꿈 문자가 포함되어있음
# score_file.close()

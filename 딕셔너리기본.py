...
tea_menu = {"Black tea" : 4000, "Green tae" : 4000, "Milk tea" : 3500}
...
# 키의 포함 여부 확인
print("Python" in dict1) # 딕셔너리에 키가 포함되어있는지 확인 True or False
print(dict1.get("자바")) # 있으면 해당 키의 값 출력, 없으면 None

#반복문에 키를 사용해서 값을 가져오기

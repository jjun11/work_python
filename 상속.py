# 오버라이딩 : 부모클래스를 상속받아 동일한 메소드에 대해 재정의해 사용하는 것
# 오버로딩 : 파이썬 오버로딩이 없음(데이터형이없어 매개변수를 아무거나 넣어도 동작하므로 오버로딩과 유사한 효과가 있음, 디폴트매개변수 문법이 있음
...
class TV(ProtoTV) : # ProtoTV 로부터 상속을 받음
